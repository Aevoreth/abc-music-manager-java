...
Later: Set Play / relays, songbook export, Band Assistant, dedicated song-layout library editor (schema change), empty-state Open User Guide, portable packaging.
